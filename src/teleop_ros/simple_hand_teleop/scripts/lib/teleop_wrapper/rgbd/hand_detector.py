...
class SingleHandDetector:
    ...
    @staticmethod
    def draw_skeleton_on_image(image, keypoint_2d: landmark_pb2.NormalizedLandmarkList, style: str = "white"): # type: ignore
        if style == "default":
    ...
    def detect(self, rgb: np.ndarray):
        ...
        keypoint_3d_array = self.parse_keypoint_3d(keypoint_3d) # [21, 3]
        keypoint_3d_array = keypoint_3d_array - keypoint_3d_array[0:1, :] # [21, 3] # 手掌局部坐标系下的keypoint_3d
    ...
    @staticmethod
    def parse_keypoint_2d(keypoint_2d: landmark_pb2.NormalizedLandmarkList, img_size) -> np.ndarray: # type: ignore
